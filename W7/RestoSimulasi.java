...
class Resto {
    ...
    public synchronized void serveCustomer(String cashierName) {// Pada metode ini, kita menggunakan synchronized untuk memastikan bahwa hanya satu thread (kasir) 
    // yang dapat mengakses dan memodifikasi chickenStock pada satu waktu.
        if (chickenStock > 0) {
